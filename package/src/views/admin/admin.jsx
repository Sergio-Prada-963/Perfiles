...
const Admin = ({ userData }) => {
  ...
  async function getDataActive() {
    try {
      const response = await axios.get("https://apicampuscv.onrender.com/api/usuarios")
  ...
  async function getDataNew() {
    try {
      const response = await axios.get("https://apicampuscv.onrender.com/api/usuarios/proceso")
  ...
  async function getDataContrato() {
    try {
      const response = await axios.get("https://apicampuscv.onrender.com/api/usuarios/contratado")
